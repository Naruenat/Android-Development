...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvHello = findViewById(com.werapun.helloworld.R.id.textView);
        ivLogo = findViewById(com.werapun.helloworld.R.id.imageView);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "คณะวิศวกรรมศาสตร์ ภาควิชาวิศวกรรมคอมพิวเตอร์", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();

                tvHello.setText("Name: Naruenat  Khunatham\nAge: 21\n5835512010");
